    <div class="max-w-3xl mx-auto bg-white p-4 shadow-md rounded-lg">
        ...
        <div class="flex justify-between mb-4">
            <a href="<?php echo site_url('admin/products/create'); ?>" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md text-sm">Create Record</a>
            <div class="relative">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <a href="<?php echo site_url('admin/products/edit/'. $product['id']); ?>" class="text-blue-500 hover:text-blue-600 mr-2">Edit</a>
                        <a href="<?php echo site_url('admin/products/delete/'. $product['id']); ?>" class="text-red-500 hover:text-red-600">Delete</a>
                    </td>
				</tr>
				<?php endforeach; ?>
			</tbody>
